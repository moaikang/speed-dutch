...
import { InvalidQueryResult, InvalidQueryResultWarning, useQuery } from './useQuery';
...
): TQueryFnData extends InvalidQueryResult ? InvalidQueryResultWarning : SuspendedUseQueryResultOnSuccess<TData>;
export function useSuspendedQuery<
  TQueryFnData = unknown,
  TError = unknown,
  TData = TQueryFnData,
...
): TQueryFnData extends InvalidQueryResult ? InvalidQueryResultWarning : SuspendedUseQueryResultOnIdle<undefined>;
export function useSuspendedQuery<
  TQueryFnData = unknown,
  TError = unknown,
  TData = TQueryFnData,
...
>(
  ...
  queryFn: QueryFunction<TQueryFnData, TQueryKey>,
  options: SuspendedUseQueryOptions<TQueryFnData, TError, TData, TQueryKey>,
): TQueryFnData extends InvalidQueryResult ? InvalidQueryResultWarning : BaseSuspendedUseQueryResult<TData | undefined>;
export function useSuspendedQuery<
  TQueryFnData = unknown,
  TError = unknown,
  TData = TQueryFnData,
...
>(
  ...
  return useQuery(queryKey, queryFn, { ...options, suspense: true }) as TQueryFnData extends InvalidQueryResult
